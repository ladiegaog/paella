// ----- la puntuación: cuatro notas y una media -----
//
// Cuatro criterios del 0 al 10. La nota global NO se guarda: es la media de los
// que estén puestos, y se calcula aquí. Así no puede quedarse desincronizada de
// sus partes cuando se edita una.
//
...
export function veredicto(nota) {
  if (nota === null) return '';
  return (VEREDICTOS.find(([umbral]) => nota >= umbral) ?? VEREDICTOS.at(-1))[1];
}
